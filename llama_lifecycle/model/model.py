...
class Transformer(nn.Module):
    ...
    def generate(self, idx, max_new_tokens, temperature=1.0, top_k=None):
        ...
        of operation for this. Also note this is a super inefficient
        version of sampling with no key/value cache.
        """
    ...
    def export(self, filepath="model.bin"):
        """Export the model weights in fp32 into .bin file to be read from
        C."""
        f = open(filepath, "wb")
