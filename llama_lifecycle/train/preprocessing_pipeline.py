...
def preprocess_dataset(output_dir: str | os.PathLike = "../../datasets/oasst1"):
    # Load dataset
    ...
    messages: dict = {"message_tree_id": [], "message_tree_text": []}
    ...
    Dataset.from_pandas(message_df).save_to_disk(output_dir)
