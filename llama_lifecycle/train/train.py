"""This training script can be run both on a single gpu in debug mode, and also
in a larger training run with distributed data parallel (ddp).
...
from llama_lifecycle.model.model import ModelArgs, Transformer
...
if master_process:
    ...
    print(
        ...
        f"{ddp_world_size} processes * {batch_size} batch size * {max_seq_len} max seq len"
    )
